  ...
  return (
    <section className="relative z-20 h-[560px] overflow-visible text-white md:h-[640px]">
        ...
        <div className="mx-auto flex h-full max-w-[1280px] items-center px-5 pt-14 md:px-8 md:pt-20">
          <div className="w-full max-w-[900px] text-left">
            <h2 className="hero-title font-black leading-[1.15] tracking-[-0.045em] text-white md:text-[52px] md:leading-[1.22]">
              <span className="hero-line hero-line-1 block whitespace-nowrap text-[27px] md:text-[52px]">
                내 미래를 바꾸는 첫걸음
              </span>
              <span className="hero-line hero-line-2 block whitespace-nowrap text-[27px] md:text-[52px]">
                자격증에서 시작하세요.
              </span>
            </h2>
            ...
            <form
              className="relative mt-5 w-full max-w-[660px] md:mt-8"
              onSubmit={(event) => {
                event.preventDefault();
                submitSearch();
              }}
            >
              <div className="group flex h-[56px] items-stretch overflow-hidden rounded-[10px] border border-white/70 bg-transparent shadow-2xl transition-colors duration-200 hover:bg-white focus-within:bg-white md:h-[64px]">
                ...
                <input
                  ...
                  className="min-w-0 flex-1 bg-transparent px-5 text-left text-[15px] font-semibold text-white outline-none placeholder:text-white transition-colors duration-200 group-hover:text-gray-700 group-hover:placeholder:text-gray-400 group-focus-within:text-gray-700 group-focus-within:placeholder:text-gray-400 md:px-6 md:text-[16px]"
                />
      ...
      <style jsx>{`
        ...
        .hero-line-1 {
          animation: heroDropIn 1.15s cubic-bezier(0.22, 1, 0.36, 1) 0.18s forwards;
        }

        .hero-line-2 {
          animation: heroDropIn 1.15s cubic-bezier(0.22, 1, 0.36, 1) 0.48s forwards;
        }

        .hero-subtitle {
          animation: heroRiseIn 1.1s cubic-bezier(0.22, 1, 0.36, 1) 0.86s forwards;
        }
